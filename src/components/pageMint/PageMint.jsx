      ...
      <div >
        <div className='background'>
              ...
              <div className='gap-mintpage'>
                <div >
                  <div >
                    ...
                    <div>
                      <h1 className="token-bar">
                        <input placeholder="TestToken" className="token-bar-text" />
                        <span className='span-style-1'>
                          Empty
                        </span>
                      </h1>
                      <p className="description-bar">
                        <input placeholder="Описание" className="description-bar-text" />
                        <span className='span-style-1'>
                          Empty
                        </span>
                      </p>
                ...
                <div className='cover-asset-area'>
                  <div className='cover-asset-area-2'>
                    <div className='cover-asset-text'>
                      <span>Тип NFT</span>
                    </div>
                    <select className='cover-asset-select'>
                      <option>Ничего</option>
                      <option>Изображение</option>
                      <option>Видео</option>
                      <option>Веб-страница</option>
                    </select>
                  </div>
                </div>
                <div className='price-remaining'>
                  ...
                  <div className='remaining-body'>
                    <div className='remaining-text'>
                      ...
                      <div className='price-space'></div>
                      <div className='price-text'>
                        <span className='color-text-gray'>Время</span>
                        <div className='price-space'></div>
                        <div className='abcd'></div>
                ...
                <div className='auction-start'>
                  <div className='auction-start-area'>
                    <button className="mint-button">
                      <span>
                        <svg>
                          <path d="M4.62471 4.00001L4.56402 4.00001C4.04134 3.99993 3.70687 3.99988 3.4182 4.055C2.2379 4.28039 1.29846 5.17053 1.05815 6.33035C0.999538 6.61321 0.999604 6.93998 0.999703 7.43689L0.999711 7.50001L0.999703 7.56313C0.999604 8.06004 0.999538 8.38681 1.05815 8.66967C1.29846 9.8295 2.2379 10.7196 3.4182 10.945C3.70688 11.0001 4.04135 11.0001 4.56403 11L4.62471 11H5.49971C5.77585 11 5.99971 10.7762 5.99971 10.5C5.99971 10.2239 5.77585 10 5.49971 10H4.62471C4.02084 10 3.78907 9.99777 3.60577 9.96277C2.80262 9.8094 2.19157 9.21108 2.03735 8.46678C2.00233 8.29778 1.99971 8.08251 1.99971 7.50001C1.99971 6.91752 2.00233 6.70225 2.03735 6.53324C2.19157 5.78895 2.80262 5.19062 3.60577 5.03725C3.78907 5.00225 4.02084 5.00001 4.62471 5.00001H5.49971C5.77585 5.00001 5.99971 4.77615 5.99971 4.50001C5.99971 4.22387 5.77585 4.00001 5.49971 4.00001H4.62471ZM10.3747 5.00001C10.9786 5.00001 11.2104 5.00225 11.3937 5.03725C12.1968 5.19062 12.8079 5.78895 12.9621 6.53324C12.9971 6.70225 12.9997 6.91752 12.9997 7.50001C12.9997 8.08251 12.9971 8.29778 12.9621 8.46678C12.8079 9.21108 12.1968 9.8094 11.3937 9.96277C11.2104 9.99777 10.9786 10 10.3747 10H9.49971C9.22357 10 8.99971 10.2239 8.99971 10.5C8.99971 10.7762 9.22357 11 9.49971 11H10.3747L10.4354 11C10.9581 11.0001 11.2925 11.0001 11.5812 10.945C12.7615 10.7196 13.701 9.8295 13.9413 8.66967C13.9999 8.38681 13.9998 8.06005 13.9997 7.56314L13.9997 7.50001L13.9997 7.43688C13.9998 6.93998 13.9999 6.61321 13.9413 6.33035C13.701 5.17053 12.7615 4.28039 11.5812 4.055C11.2925 3.99988 10.9581 3.99993 10.4354 4.00001L10.3747 4.00001H9.49971C9.22357 4.00001 8.99971 4.22387 8.99971 4.50001C8.99971 4.77615 9.22357 5.00001 9.49971 5.00001H10.3747ZM5.00038 7C4.72424 7 4.50038 7.22386 4.50038 7.5C4.50038 7.77614 4.72424 8 5.00038 8H10.0004C10.2765 8 10.5004 7.77614 10.5004 7.5C10.5004 7.22386 10.2765 7 10.0004 7H5.00038Z" fill="currentColor" fillRule="evenodd" />
                        </svg>
                      </span>
                    </button>
                    <div className='minting-space'></div>
                    <div>
                      <button className='button-minting' onClick={mintNFT}>
                        Не начался
                      </button>
                    </div>
                  </div>
          ...
          <div className='lowbar'>
            <div className='lowbar-style'>
              <div className='contract-adress'>
                <h3 className='contract-adress-text'>
                  Адрес NFT контракта:
                </h3>
                <div className='mint-adress'><div className='mint-bar'>
                  <div className='mint-bar-style'>
                    <input className='color-text-white-lowbar' />
                  </div>
                </div>
                </div>
                <div className='lowbar-space-mintpage'></div>
                <div>
                  <div className='wallet-area'>
                    <h3 className='wallet-text-style'>Адрес кошелька</h3>
                    <div className='account-adress-area'>
                      <p className='account-adress-text'>
                        <span>
                          mumbai
                          |
                          0x7791...da7a
